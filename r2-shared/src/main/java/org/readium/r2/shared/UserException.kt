...
open class UserException protected constructor(
  ...
  /**
    ...
    protected sealed class Content {
        ...
        abstract fun getUserMessage(context: Context, cause: Throwable? = null, includesCauses: Boolean = true): String
        ...
        class Message(private val message: String) : Content() {
            override fun getUserMessage(context: Context, cause: Throwable?, includesCauses: Boolean): String = message
        }
