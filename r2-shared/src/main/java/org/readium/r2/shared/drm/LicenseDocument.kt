...
class LicenseDocument {
    ...
    constructor(data: ByteArray) {
        ...
        try {
            ...
            throw Exception("Drm parsing error")
        }
        ...
        if (link("hint") == null){
            throw Exception(DrmError().errorDescription(DrmErrorCase.hintLinkNotFound))
        }
        if (link("publication") == null){
            throw Exception(DrmError().errorDescription(DrmErrorCase.publicationLinkNotFound))
        }
    }
